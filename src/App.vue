  ...
  <div class="h-full flex flex-col bg-slate-50 min-w-[1024px] overflow-hidden">
    ...
    <header class="bg-white/80 backdrop-blur-md border-b border-gray-200 px-6 flex items-center justify-between shrink-0 shadow-sm z-10">
      ...
      <div class="flex items-center space-x-4 shrink-0 ml-4 py-4">
        ...
        <!-- GitHub 链接 -->
        <el-tooltip :content="t('githubTip')" placement="bottom" effect="light">
          <a href="https://github.com/jmwyvsdgshy/aitriz" target="_blank" class="flex items-center justify-center w-9 h-9 rounded-full bg-gray-100 text-gray-600 hover:bg-gray-200 hover:text-black transition-all shadow-sm">
